...
class RectangleLabelsModelWithFinetune(ControlModel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.finetune_model_path = f"/app/models/finetuned_project_{self.project_id}.pt"
        self.annotation_counter_file = f"/app/training_data/project_{self.project_id}_counter.json"
